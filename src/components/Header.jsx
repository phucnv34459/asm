...
const Header = () => {
  return (
    <header  style={{backgroundColor:"#FF8C00"}} className="navbar sticky-top  flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a style={{backgroundColor:"#FF8C00"}}  className="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Admin</a>
